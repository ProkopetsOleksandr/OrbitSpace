...
import { useUpdateTodoItem } from '../model/update-todo-item-mutation';
import { updateTodoItemSchema, type updateTodoItemFormValues } from '../model/update-todo-item-schema';
...
export function EditTodoItemDialog({ open, onOpenChange, todoItem }: EditTaskDialogProps) {
  ...
  const {
    ...
    reset,
    formState: { errors }
  } = useForm<updateTodoItemFormValues>({
